...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        conv_out_height = (input_dim[1] + 2 * pad - filter_size) // stride + 1
        conv_out_width = (input_dim[2] + 2 * pad - filter_size) // stride + 1
        ...
        self.params['W2'] = (np.random.randn(num_filters*pool_out_height*pool_out_width, 
    ...
    def loss(self, X, y=None):
        ...
        scores, output_cache = affine_forward(hidden_out, W3, b3)
        ...
        dhidden, grads['W3'], grads['b3'] = affine_backward(dscore, output_cache)
        ...
        loss += 0.5 * self.reg * (np.sum(W3*2) + np.sum(W2**2) + np.sum(W1**2))
